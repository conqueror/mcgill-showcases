"""Write the student-facing artifacts for the course assistant showcase."""
...
def write_artifacts(
    ...
    *,
    ...
    trace_extras: Mapping[str, object] | None = None,
) -> list[Path]:
    ...
    response_path.write_text(
        _render_markdown(result, response_note=response_note),
        encoding="utf-8",
    )
...
def _render_markdown(result: AssistantResult, *, response_note: str | None = None) -> str:
    resource_lines = "\n".join(
