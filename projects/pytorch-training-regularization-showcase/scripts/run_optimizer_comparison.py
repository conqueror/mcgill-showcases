#!/usr/bin/env python3
"""Optimizer comparison entry point for the PyTorch showcase."""
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    """Parse CLI arguments for the optimizer comparison script."""
...
def main(argv: list[str] | None = None) -> int:
    """Run the optimizer comparison and write its CSV artifact."""
    ...
    table = experiments.run_optimizer_comparison(
        bundle,
